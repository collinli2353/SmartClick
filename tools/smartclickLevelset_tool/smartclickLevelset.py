...
from tools.smartclickLevelset_tool.CNN.tool import tool
from tools.smartclickLevelset_tool.ui_smartclickCNN import *
from utils.globalConstants import IMG_OBJ, MSK_OBJ
from utils.utils import theBrushPen

class smartclickLevelset(QtWidgets.QWidget, default_tool, metaclass=Meta):
    def __init__(self):
